      ...
      <div className="">
        ...
        <div className="flower-content-textbox">
          <div className="flower-content-textbox-item">
            <span>
              <h1 className="subheadline text-white" ref={textRef1}>
                Grow
              </h1>
            </span>
            <span>
              <h1 className="subheadline text-white" ref={textRef2}>
                Your
              </h1>
            </span>
            <span>
              <h1 className="subheadline text-white" ref={textRef3}>
                Digital
              </h1>
            </span>
            {/* <span>
          ...
          <div className="flower-content-textbox-item">
            <span>
              <h1 className="subheadline text-white" ref={textRef4}>
                Presence,
              </h1>
            </span>
            <span>
              <h1 className="subheadline text-white" ref={textRef5}>
                Let
              </h1>
            </span>
            <span>
              <h1 className="subheadline text-white" ref={textRef6}>
                Your
              </h1>
            </span>
          </div>
          <div className="flower-content-textbox-item">
            <span>
              <h1 className="subheadline text-white" ref={textRef7}>
                Vision
              </h1>
            </span>
            {/* <span>
